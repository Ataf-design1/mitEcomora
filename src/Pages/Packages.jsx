...
const Packages = () => {
  ...
  async function fetchData() {
    try {
      ...
      if (res.data) {
        let productsArray = Object.values(res.data);
        productsArray = getRandomProducts(productsArray, 15).map(product => applyDiscount(product, 0.1));
  ...
  return (
    <div className="marketplace-container">
      <div className="discount-banner">
        🔥 Limited Time Offer: 10% OFF on all products! 🎉
      </div>
